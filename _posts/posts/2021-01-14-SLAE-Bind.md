...
We now may have a bind shell. However, this is completely useless if it isn't functional, right? This is where dup2 comes in, our little friend will copy into our accepted requests STDIN (0), STDOUT (1), and STDERR (2) file descriptors, therefore making the connection interactive.

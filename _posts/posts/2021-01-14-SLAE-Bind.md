...
As you can see, the value of EAX has been copied to ESI, this will be very useful as storage of the sockfd value from socket for later operations.
...
According to the manpage, the arguments are the following ```int bind(int sockfd, const struct sockaddr *addr, socklen_t addrlen);```

...
is prompted as well, here we insert our page to clone, which in our case will be a CMS Admin login from the machine ```Ignite``` from [tryhackme](http://tryhackme.com)
